...
from myPSNR import myOtsuKPSNR
...
#  dataobj[3, rep] = obj
  ...
  plt.imsave(os.path.splitext(filename)[0]+'_Expectation_k'+str(Clases)+'.eps', imagen2, cmap='gray')
...
#  imagen2, obj, thresholds = myOtsuKPSNR('images/'+x.rstrip(), Clases)
#  plt.imsave(os.path.splitext(filename)[0]+'_OtsuPSNR_k'+str(Clases)+'.eps', imagen2, cmap='gray')
#  dataPSNR[6, rep] = PSNR(imagen2, imagenref)
#  dataSSIM[6, rep] = SSIM(imagen2, imagenref)
#  dataobj[6, rep] = obj
 ...
 cont +=1
 print str(np.average(dataPSNR[0,:])) + " " +str(np.average(dataPSNR[1,:]))+" "+str(np.average(dataPSNR[2,:])) + " " +str(np.average(dataPSNR[3,:]))+ " " +str(np.average(dataPSNR[4,:]))+ " " +str(np.average(dataPSNR[5,:]))+ " " +str(np.average(dataPSNR[6,:]))
 print str(np.average(dataSSIM[0,:])) + " " +str(np.average(dataSSIM[1,:]))+" "+str(np.average(dataSSIM[2,:])) + " " +str(np.average(dataSSIM[3,:]))+ " " +str(np.average(dataSSIM[4,:]))+ " " +str(np.average(dataSSIM[5,:]))+ " " +str(np.average(dataSSIM[6,:]))
 print str(np.average(dataobj[0,:])) + " " +str(np.average(dataobj[1,:]))+" "+str(np.average(dataobj[2,:])) + " " +str(np.average(dataobj[3,:]))+ " " +str(np.average(dataobj[4,:]))+ " " +str(np.average(dataobj[5,:]))+ " " +str(np.average(dataobj[6,:]))
 
print str(np.average(AveragePSNR[0,:])) + " " +str(np.average(AveragePSNR[1,:]))+" "+str(np.average(AveragePSNR[2,:])) + " " +str(np.average(AveragePSNR[3,:]))+ " " +str(np.average(AveragePSNR[4,:]))+ " " +str(np.average(AveragePSNR[5,:]))+ " " +str(np.average(AveragePSNR[6,:]))
print str(np.average(AverageSSIM[0,:])) + " " +str(np.average(AverageSSIM[1,:]))+" "+str(np.average(AverageSSIM[2,:])) + " " +str(np.average(AverageSSIM[3,:]))+ " " +str(np.average(AverageSSIM[4,:]))+ " " +str(np.average(AverageSSIM[5,:]))+ " " +str(np.average(AverageSSIM[6,:]))
print str(np.average(AverageObjective[0,:])) + " " +str(np.average(AverageObjective[1,:]))+" "+str(np.average(AverageObjective[2,:])) + " " +str(np.average(AverageObjective[3,:]))+ " " +str(np.average(AverageObjective[4,:]))+ " " +str(np.average(AverageObjective[5,:]))+ " " +str(np.average(AverageObjective[6,:]))
