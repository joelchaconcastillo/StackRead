...
def OptimizationDE(npop, Niterations, minv, maxv, Mt, AccumPi, AccumiPi, dimension):
  ...
  for target in range(0, npop):
   ...
   evaluations[target] = ObjectiveFunctionKapur(pop[target,:], minv, maxv, Mt, AccumPi, AccumiPi)
...
#       F = 0.9
	...
	if trial[d] < minv:
	 trial[d] = maxv-1
       objtrial = ObjectiveFunctionKapur(trial, minv, maxv, Mt, AccumPi, AccumiPi)
       ##Selection
...
def GeneralizedKapurDE(filename, Classes, PopulationSize, Niterations):
